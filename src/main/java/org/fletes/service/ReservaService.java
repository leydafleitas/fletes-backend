...
public class ReservaService {
    ...
    public Reserva actualizarReserva(Long reservaId, Long camionId, Long clienteId, String origen, String destino,
                                     LocalDate fechaInicio, LocalDate fechaFin, Double volumenCarga) {
        ...
        if (!camionDisponible(camionId, fechaInicio, fechaFin, reservaId))
            throw new IllegalStateException("El camión no está disponible en las fechas indicadas.");
